  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[8%] top-16 h-72 w-72 rounded-full bg-[#6A1BFF]/16 blur-[110px]" />
        <div className="absolute left-[-40px] bottom-8 h-72 w-72 rounded-full bg-[#20B8FF]/8 blur-[110px]" />
      </div>
      ...
      <div className="relative mx-auto grid w-[min(1160px,calc(100%-32px))] gap-12 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div
          ...
          className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 shadow-[0_24px_90px_rgba(0,0,0,0.22)] backdrop-blur md:p-8"
        >
